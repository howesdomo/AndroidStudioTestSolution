...
public class StaticInfo
{
    ...
    protected static String appName = "考泰斯扫描打印";
    ...
    /**
     * SharedPreferences Key - 打印指令模版
     */
    public static final String SharedPKey_ZPLTemplate = "SPKey_Template";
    
    /**
     * 打印指令默认模版
     */
    public static final String Template_Default = "^LH{0},{1}^XA^FO60,60^A0N,16,16^FD{2}^FS^FO60,100^BQN,2,6^FDQA,{2}^FS^PQ{3}^XZ";
     ...
     * @param context
     */
    public static void LoadZPLTemplate(Context context)
    {
        SharedPreferences sp = context.getSharedPreferences(StaticInfo.ConfigTag, 0);
        String zpl = sp.getString(SharedPKey_ZPLTemplate, Template_Default);
        StaticInfo.PrintZPLTemplate = zpl;
    }
     ...
     * @param context
     */
    public static void SaveZPLTemplate(Context context, String c)
    {
        SharedPreferences sp = context.getSharedPreferences(StaticInfo.ConfigTag, 0);
        StaticInfo.PrintZPLTemplate = c;
        
        SharedPreferences.Editor editor = sp.edit();
        editor.putString(SharedPKey_ZPLTemplate, c);
        editor.commit();
    }
