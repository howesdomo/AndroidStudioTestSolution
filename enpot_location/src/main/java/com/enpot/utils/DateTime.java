...
public class DateTime implements Serializable
{
    ...
    /**
     * 仿照 C# DateTime 的 Date属性
     */
    public DateTime getDate()
    {
        DateTime r = new DateTime(this.c.getTimeInMillis());
        
        r.set(DateTime.HOUR_FIELD, 0);
        r.set(DateTime.MINUTE_FIELD, 0);
        r.set(DateTime.SECOND_FIELD, 0);
        r.set(DateTime.MILLISECOND_FIELD, 0);
