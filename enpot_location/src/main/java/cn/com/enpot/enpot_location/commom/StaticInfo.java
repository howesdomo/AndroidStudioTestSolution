package cn.com.enpot.enpot_location.commom;
...
import cn.com.enpot.enpot_location.R;
...
public class StaticInfo
{
    ...
    protected static String appName = "雄冠定位监视";
    
    /**
     * 公司号
     */
    public static String CompanyCode = "BP02";
     ...
     * 删除窗口 -- 请求码
     */
    public static int DeleteActivity_RequestCode = 400;
    
    /**
     * 删除窗口 -- 确认
     */
    public static int DeleteActivity_Result_SubmitCode = 200;
    
    /**
     * 删除窗口 -- 取消
     */
    public static int DeleteActivity_Result_CancelCode = 201;
    
    public static int MaterialOutPrintSendOut_2_MantissaBox_RequestCode = 200;
    
    public static int MaterialOutPrintSendOut_2_ChangeBox_RequestCode = 300;
    
    public static int MaterialOutPrintSendOut_ResultCode_Submit = 200;
    
    public static int MaterialOutPrintSendOut_ResultCode_Cancel = -200;
    ...
    public static String GetVersionName(Activity activity)
    {
        ...
        return ((Integer) StaticInfo.versionCode).toString();
    }
     ...
     * 服务IP
     */
    public static String IP = "192.168.1.215"; //"192.168.1.215";
    
    /**
     * 服务端口
     */
    public static String Port = "17906"; //"17901";
    ...
    public static String GetLastestEndPoint()
    {
        if (StaticInfo.IsDebugMode() == true)
        {
            ...
            StaticInfo.Port = "17906";
            // StaticInfo.EndPoint = "http://192.168.1.215:17901/APP_Server/APP_WebService.asmx";
